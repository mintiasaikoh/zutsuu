...
struct EvidenceRule: Identifiable {
    ...
    static let all: [EvidenceRule] = [
        EvidenceRule(
            title: "気圧の変化を、絶対値より重く見る",
            basis: "6 時間前からの気圧低下が頭痛の発生をもっとも強く説明し、気圧そのものの高低より変化のほうが効くことが、4 万人規模の記録で示されています。6 時間の窓を置いているのはこのためです。",
            references: [.katsuki2023]),
        EvidenceRule(
            title: "下がるときも、上がるときも見る",
            basis: "低気圧ではなく高気圧や気圧の上昇で不調になる人が実在し、集団の平均では効果が打ち消されることがあります。7 千人規模の発作記録でも、1 日で 20 hPa 以上上がった日に発作が増えていました。",
            references: [.becker2011, .portt2026]),
        EvidenceRule(
            title: "雨の配点は小さめ",
            basis: "雨は湿度や気圧と一緒に動くため、それだけの寄与は小さいと分かっています。4 万人規模の記録では気象要因のうち最下位、2 千人規模の慢性痛の記録では差がありませんでした。",
